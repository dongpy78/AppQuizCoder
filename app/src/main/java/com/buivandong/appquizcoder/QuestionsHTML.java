...
public class QuestionsHTML extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questions_html);
        findsView();
    ...
    private void list_questions() {
        list.add(new QuestionModel("The <p> tap is used for:", "paragraph", "page", "pointer", "parser", "paragraph"));
        list.add(new QuestionModel("What is the output of this code ? <div class='sum'>(3+6)/2</div>", "4", "(3+6)/2", "4.5", "6", "(3+6)/2"));
        list.add(new QuestionModel("To make the table have the whole width of the viewer's browser window irrespective of its width, you should specify a table width of:", "50%", "1000px", "100%", "600px", "100%"));
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(QuestionsHTML.this, TongKetActivity.class);
