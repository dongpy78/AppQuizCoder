...
public class QuestionsJava extends AppCompatActivity {
    ...
    private void list_questions() {
        ...
        list.add(new QuestionModel("How do you create a variable with the floating number 2.8 ?", "int x = 2.8f;", "x = 2.8f;", "float x = 2.8f;", "byte x = 2.8f;", "float x = 2.8f;"));
        list.add(new QuestionModel("Which method can be used to return a string in upper case letters ?", "tuc()", "toUpperCase()", "upperCase()", "touppercase()", "toUpperCase()"));
        list.add(new QuestionModel("Which keyword is used to import a package from the Java API library ?", "lib", "package", "getlib", "import", "import"));
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(QuestionsJava.this, TongKetActivity.class);
