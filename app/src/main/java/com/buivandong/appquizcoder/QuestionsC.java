...
public class QuestionsC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questions_c);
        findsView();
    ...
    private void list_questions() {
        list.add(new QuestionModel("Which data type is used to create a variable that should store text ?", "String", "string", "myString", "Txt", "string"));
        list.add(new QuestionModel("How do you create a variable with the numeric value 5 ?", "num x = 5;", "double x = 5;", "x = 5;", "int x = 5;", "int x = 5;"));
        list.add(new QuestionModel("Which method can be used to find the length of a string ?", "getLength()", "len()", "length()", "getSize()", "length()"));
        list.add(new QuestionModel("How do you create a function in C++ ?", "functionName[]", "(functionName)", "functionName()", "functionName", "functionName()"));
        list.add(new QuestionModel("Which method can be used to find the highest value of x and y ?", "max(x,y)", "largest(x,y)", "maxNum(x,y)", "maximum(x,y)", "max(x,y)"));
        list.add(new QuestionModel("How do you create a reference variable of an existing variable ?", "With the REF word", "With the ref word", "With the & operator", "With the * operator", "With the & operator"));
        list.add(new QuestionModel("Which statement is used to stop a loop ?", "stop", "break", "return", "exit", "break"));
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(QuestionsC.this, TongKetActivity.class);
